  ...
  static TextTheme _buildTextTheme(TextTheme base) {
    return base.copyWith(
      ...
      button: GoogleFonts.openSans(
        textStyle: TextStyle(color: base.button.color, fontSize: 10, fontWeight: FontWeight.w600),
      ),
      caption: GoogleFonts.openSans(
        textStyle: TextStyle(color: base.caption.color, fontSize: 8),
      ),
      headline4: GoogleFonts.openSans(
        textStyle: TextStyle(color: base.headline4.color, fontSize: 23),
      ),
